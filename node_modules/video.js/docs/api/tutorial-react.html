...
<head>
    <meta charset="utf-8">
    <title>Tutorial: react | Video.js Documentation</title>
...
<section>
    <header>
        ...
        <article class="readme">
            <h1 id="videojs-and-reactjs-integration">Video.js and ReactJS integration</h1>
<p>Here's a basic ReactJS player implementation.</p>
<p>It just instantiates the Video.js player on <code>componentDidMount</code> and destroys it on <code>componentWillUnmount</code>.</p>
...
}</code></pre><p>You can then use it like this: (see <a href="tutorial-options.html">options guide</a> for option information)</p>
<pre class="prettyprint source lang-jsx"><code>const videoJsOptions = {
  autoplay: true,
  controls: true,
  sources: [{
...
return &lt;VideoPlayer { ...videoJsOptions } /></code></pre><p>Don't forget to include the Video.js CSS, located at <code>video.js/dist/video-js.css</code>.</p>
<h2 id="using-a-react-component-as-a-videojs-component">Using a React Component as a Video JS Component</h2>
